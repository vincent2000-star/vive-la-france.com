...
<body>
    ...
    <section id="vehicules">
        <h2>Nos Véhicules</h2>
        <div class="vehicle">
            <img src="https://img.gta5-mods.com/q75/images/wheel-bmw-827m-replace/dfe038-21.png" alt="Voiture 1">
            <h3>Bmw 827M</h3>
            <p>Prix: 20€</p>
        </div>
        <div class="vehicle">
            <img src="car2.jpg" alt="Voiture 2">
            <h3>Elegy Retro Custom</h3>
            <p>Prix: 70,000€</p>
        </div>
        <div class="vehicle">
            <img src="car3.jpg" alt="Voiture 3">
            <h3>Vapid Dominator</h3>
            <p>Prix: 40,000€</p>
        </div>
    </section>
